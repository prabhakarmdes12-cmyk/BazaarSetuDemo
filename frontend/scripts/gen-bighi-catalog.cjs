...
const CATALOG = {
  ...
  staples: [
    ...
    // ---- Khula / White-Label Dukaan Staples (High-velocity Dhanbad bulk lines) ----
    { n: 'Chakki Fresh Atta (Khula)', brands: ['Dukaan Fresh'], packs: [['1 kg', 0.22], ['2 kg', 0.42], ['5 kg bag', 1], ['10 kg bag', 1.85]], p: 180 },
    { n: 'Usna Chawal / Parboiled Rice (Khula)', brands: ['Dukaan Fresh'], packs: [['1 kg', 0.22], ['5 kg bag', 1], ['10 kg bag', 1.85], ['25 kg bori', 4.3]], p: 210 },
    { n: 'Arwa Chawal / Raw Rice (Khula)', brands: ['Dukaan Fresh'], packs: [['1 kg', 0.22], ['5 kg bag', 1], ['10 kg bag', 1.85]], p: 220 },
    { n: 'Govindobhog Kheer Chawal (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 110 },
    { n: 'Desi Arhar / Toor Dal (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1], ['2 kg', 1.95]], p: 135 },
    { n: 'Chana Dal (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 78 },
    { n: 'Masoor Dal / Lal Dal (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 82 },
    { n: 'Moong Dal Dhuli (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 115 },
    { n: 'Urad Dal Dhuli (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 118 },
    { n: 'Kala Chana Desi (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 72 },
    { n: 'Kabuli Chana (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 105 },
    { n: 'Peeli Matar for Ghugni (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 60 },
    { n: 'Chana Sattu Pure (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.28], ['500 g', 0.52], ['1 kg', 1]], p: 90 },
    { n: 'Chana Besan (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 75 },
    { n: 'Clean White Sugar / Cheeni (Khula)', brands: ['Dukaan Fresh'], packs: [['1 kg', 0.22], ['2 kg', 0.42], ['5 kg bag', 1]], p: 205 },
    { n: 'Desi Bheli Gud / Jaggery (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 55 },
    { n: 'Maida Refined Flour (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 38 },
    { n: 'Sooji / Rawa (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 42 },
    { n: 'Sabudana / Sago (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.28], ['500 g', 0.52], ['1 kg', 1]], p: 85 },
    { n: 'Daliya / Broken Wheat (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 55 },
    { n: 'Makai Atta / Maize Flour (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 45 },
    { n: 'Sendha Namak / Rock Salt (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.55], ['1 kg', 1]], p: 50 },
    { n: 'Kala Namak / Black Salt (Khula)', brands: ['Dukaan Fresh'], packs: [['200 g', 0.45], ['500 g', 1]], p: 45 },
    { n: 'Masoor Sabut / Whole Red Lentils (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 88 },
    { n: 'Moong Sabut / Whole Green Moong (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 110 },
    { n: 'Urad Sabut / Whole Black Urad (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 115 },
    { n: 'Rajma Chitra (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.52], ['1 kg', 1]], p: 135 },
  ],
  oils: [
    ...
    // ---- Khula Whole Spices & Khada Masala (Local Kirana Counter Packs) ----
    { n: 'Sabut Jeera / Cumin Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.28], ['100 g', 0.52], ['250 g', 1], ['500 g', 1.95]], p: 140 },
    { n: 'Sabut Golki / Black Pepper (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.35], ['100 g', 0.65], ['250 g', 1]], p: 210 },
    { n: 'Sabut Khada Dhania (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.3], ['250 g', 0.65], ['500 g', 1]], p: 90 },
    { n: 'Haldi Ganth / Whole Turmeric (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.35], ['250 g', 0.7], ['500 g', 1]], p: 95 },
    { n: 'Badi Elaichi / Black Cardamom (Khula)', brands: ['Dukaan Fresh'], packs: [['25 g', 0.55], ['50 g', 1]], p: 110 },
    { n: 'Chhoti Hari Elaichi (Khula)', brands: ['Dukaan Fresh'], packs: [['25 g', 0.55], ['50 g', 1]], p: 160 },
    { n: 'Sabut Laung / Cloves (Khula)', brands: ['Dukaan Fresh'], packs: [['25 g', 0.55], ['50 g', 1]], p: 75 },
    { n: 'Dalchini / Cinnamon Sticks (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 65 },
    { n: 'Tejpatta / Bay Leaves (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 35 },
    { n: 'Methi Dana & Ajwain (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.3], ['100 g', 0.55], ['250 g', 1]], p: 60 },
    { n: 'Saunf / Fennel Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.3], ['100 g', 0.55], ['250 g', 1]], p: 70 },
    { n: 'Peeli Sarson / Mustard Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.5], ['250 g', 1]], p: 40 },
    { n: 'Rai / Small Mustard Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.5], ['250 g', 1]], p: 42 },
    { n: 'Mangrela / Kalonji / Onion Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 65 },
    { n: 'Khada Garam Masala Mix (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 95 },
    { n: 'Sukhi Lal Mirch Sabut (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.45], ['250 g', 1]], p: 90 },
    { n: 'Kasuri Methi (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 45 },
    { n: 'Hing Powder / Compounded Asafoetida (Khula)', brands: ['Dukaan Fresh'], packs: [['25 g', 0.55], ['50 g', 1]], p: 55 },
  ],
  munchies: [
    ...
    // ---- Khula Kirana Snacks and Muri/Chooda ----
    { n: 'Muri / Puffed Rice (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.3], ['500 g', 0.55], ['1 kg', 1]], p: 45 },
    { n: 'Chooda / Flattened Rice Medium (Khula)', brands: ['Dukaan Fresh'], packs: [['500 g', 0.55], ['1 kg', 1]], p: 55 },
    { n: 'Chivda / Chooda Fry Namkeen (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.55], ['500 g', 1]], p: 90 },
    { n: 'Barik Sev / Bhujiya (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.55], ['500 g', 1]], p: 95 },
    { n: 'Dalmoth Mixture (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.55], ['500 g', 1]], p: 95 },
    { n: 'Chana Chur Namkeen (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.55], ['500 g', 1]], p: 85 },
    { n: 'Rusk / Toast Biscuit (Khula White-Label)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.55], ['500 g', 1]], p: 65 },
    { n: 'Papad Desi Urad & Moong (Khula)', brands: ['Dukaan Fresh'], packs: [['200 g', 0.55], ['400 g', 1]], p: 90 },
  ],
  biscuits: [
    ...
    { n: 'Choco Fills Cookies', brands: ['Sunfeast Dark Fantasy', 'Cadbury Bournvita Biscuits'], packs: [['75 g', 0.5], ['150 g', 0.72], ['300 g', 1]], p: 80 },
    ...
    { n: 'Monaco Salted Biscuits', brands: ['Parle Monaco'], packs: [['100 g', 0.4], ['200 g', 0.82], ['250 g', 1]], p: 35 },
  ...
  drinks: [
    ...
    { n: 'Apple Juice', brands: ['Real Fruit Power', 'Tropicana', 'B Natural'], packs: [['200 ml', 0.3], ['1 L carton', 1]], p: 115 },
    { n: 'Mixed Fruit Juice', brands: ['Real Fruit Power', 'Tropicana', 'B Natural'], packs: [['200 ml', 0.3], ['1 L carton', 1]], p: 110 },
    { n: 'Guava Chili Juice', brands: ['Paper Boat', 'Real Fruit Power'], packs: [['200 ml', 0.3], ['1 L carton', 1]], p: 120 },
  ...
  tea: [
    { n: 'Premium Leaf Tea', brands: ['Tata Tea Gold', 'Tata Agni', 'Red Label', 'Tetley', 'Taj Mahal'], packs: [['250 g', 0.45], ['500 g', 0.85], ['1 kg', 1]], p: 280 },
    { n: 'Strong CTC Tea', brands: ['Brooke Bond Red Label', 'Society', 'Wagh Bakri', 'Tata Tea Taaza'], packs: [['250 g', 0.45], ['500 g', 0.85], ['1 kg', 1]], p: 250 },
  ...
  household: [
    ...
    { n: 'Top-Load Detergent', brands: ['Surf Excel', 'Ariel', 'Ghadi', 'Tide Plus'], packs: [['1 kg', 0.45], ['4 kg', 1]], p: 220 },
    { n: 'Detergent Washing Bar', brands: ['Rin', 'Wheel', 'Nirma'], packs: [['250 g bar', 0.3], ['4 pack', 1]], p: 60 },
    { n: 'Fabric Conditioner', brands: ['Comfort', 'Downy'], packs: [['220 ml', 0.35], ['860 ml', 1]], p: 210 },
    ...
    { n: 'Room Freshener', brands: ['Godrej Aer', 'Odonil', 'Ambipur'], packs: [['50 g block', 0.35], ['gel pack', 0.6], ['270 ml spray', 1]], p: 140 },
    ...
    { n: 'Kitchen Towel Roll', brands: ['Origami', 'Premier'], packs: [['2 rolls 2-ply', 1], ['4 rolls 2-ply', 1.8]], p: 150 },
  ...
  personal: [
    ...
    { n: 'Shampoo', brands: ['Sunsilk', 'Dove', 'Clinic Plus'], packs: [['175 ml', 0.48], ['180 ml', 0.5], ['340 ml', 0.8], ['650 ml', 1]], p: 260 },
    { n: 'Strong Teeth Toothpaste', brands: ['Colgate Strong Teeth', 'Pepsodent', 'Sensodyne'], packs: [['100 g', 0.4], ['200 g', 0.7], ['300 g', 1]], p: 110 },
    { n: 'Sensitivity Relief Toothpaste', brands: ['Sensodyne', 'Colgate Sensitive', 'Vantej'], packs: [['75 g', 1], ['150 g', 1.85]], p: 145 },
    ...
    { n: 'Manual Razor', brands: ['Gillette Presto', 'Gillette', '7 O’clock'], packs: [['1 razor', 0.5], ['5 razor pack', 0.9], ['4 cartridge', 1]], p: 120 },
    ...
    { n: 'Hair Oil', brands: ['Parachute Coconut', 'Bajaj Almond', 'Dabur Amla'], packs: [['100 ml', 0.3], ['200 ml', 0.48], ['300 ml', 0.65], ['500 ml', 1]], p: 120 },
  ...
  dryfruits: [
    ...
    // ---- Khula Mewa & Dry Fruits (Dukaan Weigh-and-Pack) ----
    { n: 'Kaju Tukda 2-Piece Splits (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.28], ['250 g', 0.6], ['500 g', 1]], p: 380 },
    { n: 'Sabut Kaju W320 (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.28], ['250 g', 0.6], ['500 g', 1]], p: 440 },
    { n: 'Kismis / Raisins (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.28], ['250 g', 0.6], ['500 g', 1]], p: 180 },
    { n: 'Badaam Giri (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.28], ['250 g', 0.6], ['500 g', 1]], p: 400 },
    { n: 'Phool Makhana Jumbo (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.28], ['250 g', 0.6], ['500 g', 1]], p: 260 },
    { n: 'Akhrot Giri / Walnut Kernels (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.45], ['250 g', 1]], p: 260 },
    { n: 'Anjeer / Dried Figs (Khula)', brands: ['Dukaan Fresh'], packs: [['200 g', 0.45], ['500 g', 1]], p: 480 },
    { n: 'Magaz / Char Magaz Melon Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['100 g', 0.45], ['250 g', 1]], p: 180 },
    { n: 'Posta Dana / Khus Khus / Poppy Seeds (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 190 },
    { n: 'Sukha Gari / Dry Coconut Copra (Khula)', brands: ['Dukaan Fresh'], packs: [['1 pc ~200 g', 0.5], ['500 g', 1]], p: 120 },
  ],
  ...
  pooja: [
    ...
    // ---- Khula Ritual and Pooja Samagri ----
    { n: 'Shudh Desi Kapoor (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 65 },
    { n: 'Gol Batti Cotton Wicks (Khula)', brands: ['Dukaan Fresh'], packs: [['100 pcs', 0.5], ['250 pcs', 1]], p: 35 },
    { n: 'Lambi Batti Cotton Wicks (Khula)', brands: ['Dukaan Fresh'], packs: [['100 pcs', 0.5], ['250 pcs', 1]], p: 35 },
    { n: 'Hawan Samagri Packet (Khula)', brands: ['Dukaan Fresh'], packs: [['250 g', 0.55], ['500 g', 1]], p: 75 },
    { n: 'Roli / Kumkum Packet (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 30 },
    { n: 'Peela Chandan Powder (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 35 },
    { n: 'Mauli / Raksha Sutra Dhaga (Khula)', brands: ['Dukaan Fresh'], packs: [['1 pc gola', 0.4], ['3 pcs set', 1]], p: 40 },
    { n: 'Supari Akhand Pooja (Khula)', brands: ['Dukaan Fresh'], packs: [['10 pcs', 0.45], ['25 pcs', 1]], p: 50 },
    { n: 'Sindoor Desi (Khula)', brands: ['Dukaan Fresh'], packs: [['50 g', 0.55], ['100 g', 1]], p: 35 },
  ],
  ...
  paan: [
    ...
    { n: 'Spearmint Chewing Gum', brands: ['Orbit', 'Center Fresh', 'Happydent'], packs: [['blister pack', 1], ['jar of 30', 2.6]], p: 30 },
